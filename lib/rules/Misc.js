var CSSCompressor = global.CSSCompressor,
	...
	rparengrouping = /^([a-z\-_]+)\((.*?)\)$/i;


CSSCompressor.addValue([

	{
		name: 'Paren Whitespace',
		group: 'Misc',
		description: "General whitespace removal of paren declarations.",
		callback: function( value, position, compressor ) {
			var m = rparengrouping.exec( value ),
				string = '', c = '',
				parts = [], match, seek,
				i = -1, l,
				k, kl;
